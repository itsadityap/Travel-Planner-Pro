...
class GetDestination{
    ...
    constructor(id, cityName, latitude, longitude, landmarks, state, description, images, avgTravelExpenses, attractions, category, currentWeather, weatherIcon, currentTemperature){
        this.id = id;
