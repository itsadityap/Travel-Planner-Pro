...
async function seeItenery(req, res)
{
    try
    {
        ...
        const itenObject = new IteneryResponse(iten.planName, iten.destination, iten.travelStartDate, iten.travelEndDate, iten.travelMode,iten.details ,iten.travelMode)
...
async function createdIteniries(req, res)
{
    try
    {
        ...
        const itenObject = iten.map(it => new IteneryResponse(it.planName, it.destination, it.travelStartDate, it.travelEndDate, it.travelMode,it.details ,it.travelMode));
